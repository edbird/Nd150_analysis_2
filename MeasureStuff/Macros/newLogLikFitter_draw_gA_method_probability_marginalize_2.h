...
*/
        std::cout << "1 sigma (low ext): " << g_cumulative_xi_31_low_ext_reverse->Eval((1.0 - 0.683) / 2.0) << std::endl;
        std::cout << "90 % (low ext): " << g_cumulative_xi_31_low_ext_reverse->Eval((1.0 - 0.90) / 2.0) << std::endl;
        std::cout << "1 sigma (high ext): " << g_cumulative_xi_31_high_ext_reverse->Eval((1.0 - 0.683) / 2.0) << std::endl;
        std::cout << "90 % (high ext): " << g_cumulative_xi_31_high_ext_reverse->Eval((1.0 - 0.90) / 2.0) << std::endl;

        std::cout << "*** bin index ***" << std::endl;
        std::cout << h_marginal_xi_31->GetXaxis()->FindBin(g_cumulative_xi_31_low_ext_reverse->Eval((1.0 - 0.683) / 2.0)) << std::endl;
        std::cout << h_marginal_xi_31->GetXaxis()->FindBin(g_cumulative_xi_31_low_ext_reverse->Eval((1.0 - 0.90) / 2.0)) << std::endl;
        std::cout << h_marginal_xi_31->GetXaxis()->FindBin(g_cumulative_xi_31_high_ext_reverse->Eval((1.0 - 0.683) / 2.0)) << std::endl;
        std::cout << h_marginal_xi_31->GetXaxis()->FindBin(g_cumulative_xi_31_high_ext_reverse->Eval((1.0 - 0.90) / 2.0)) << std::endl;
...
//        h_marginal_T12_clone->SetLineStyle(9);
...
//            double content = peak_y * std::exp(-0.5 * std::pow((x - 1.19333) / (0.0694279), 2.0));
        ...
        g_marginal_T12_estimated_A->SetFillColor(kOrange - 3);
        g_marginal_T12_estimated_A->SetFillStyle(3002);
        g_marginal_T12_estimated_A->SetLineColor(kOrange - 3);
        g_marginal_T12_estimated_A->SetLineWidth(0);
//        g_marginal_T12_estimated_A->SetLineStyle();
        g_marginal_T12_estimated_A->Draw("Lf");

        g_marginal_T12_estimated_C->SetFillColor(kBlue - 4);
        g_marginal_T12_estimated_C->SetFillStyle(3002);
        g_marginal_T12_estimated_C->SetLineColor(kBlue - 4);
        g_marginal_T12_estimated_C->SetLineWidth(0);
        g_marginal_T12_estimated_C->Draw("Lf");

        g_marginal_T12_estimated_D->SetFillColor(kBlue - 4);
        g_marginal_T12_estimated_D->SetFillStyle(3002);
        g_marginal_T12_estimated_D->SetLineColor(kBlue - 4);
        g_marginal_T12_estimated_D->SetLineWidth(0);
        g_marginal_T12_estimated_D->Draw("Lf");
        ...
        TString s2 = "#mu = 1.1933";
        TString s1 = "#sigma = 0.0694";

        latex.DrawLatex(0.72, 0.67, s2);
        latex.DrawLatex(0.72, 0.60, s1);

        TString s3;
        s3.Form("#int_{0.95}^{1.45} P(A^{^{150}Nd}) dA^{^{150}Nd} = 1");
        latex.SetTextColor(kBlack);
        latex.SetTextSize(15);
        latex.DrawLatex(0.15, 0.79, s3);

        TString s5;
        s5.Form("#int_{1.124}^{1.263} P(A^{^{150}Nd}) dA^{^{150}Nd} = 1#sigma");
        latex.SetTextColor(kOrange - 3);
        latex.DrawLatex(0.15, 0.55, s5);

        TString s4;
        s4.Form("#int_{1.079}^{1.307} P(A^{^{150}Nd}) dA^{^{150}Nd} = 90 %%");
        latex.SetTextColor(kBlue - 4);
        latex.DrawLatex(0.15, 0.67, s4);
